...
export const seedEmailLogs: EmailLog[] = [
  {
    ...
    body: 'Requestor ThomasCustomer submitted requisition for 2 items, purpose: Project kickoff supplies.',
  ...
  },
  {
    ...
    body: 'Requestor ThomasCustomer submitted requisition for 4 items, purpose: Site mobilization PPE.',
    eventType: 'RequisitionSubmitted',
    read: true,
  },
  {
